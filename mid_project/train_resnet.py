...
def main(): 
    ...
    for x,data in enumerate(stf):
        ...
        net.fc=nn.Sequential(nn.Linear(net.fc.in_features, 8), 
            nn.Tanh(),
            nn.Linear(8, 3))
        ...
        # validate the model
            ...
            # calculate the accuracy of the validation predictions
                ...
                epoch, MAX_EPOCH, i+1, len(train_loader), loss_val, val_acc,val_Auc,sensitivity[0],sensitivity[1],specificity[0],specificity[1]))
        ...
        c.save("training_progress of folder of resnet18 {:0>2}.png".format(x+1))
    ...
    ax.get_figure().savefig('Final_acc for resnet.png')
    plt.cla()
    plt.clf()
    ...
    ax.get_figure().savefig('Final_Auc for resnet.png')
    plt.cla()
    plt.clf()
